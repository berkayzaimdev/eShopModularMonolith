...
public static class InitialData
{
	...
	[
		Product.Create(new Guid("5334c996-8457-4cf0-815c-ed2b77c4ff61"), "iPhone 10", ["category1"], "Long description", "imagefile", 1000),
		Product.Create(new Guid("c67d6323-e8b1-4bdf-9a75-b0d0d2e7e914"), "Samsung X", ["category1"], "Long description", "imagefile", 1000),
